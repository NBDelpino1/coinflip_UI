...
var sound2 = document.getElementById("reset-button-sound-effect");
...
function coinToss (){
    ...
    setTimeout(function(){
        ...
        if(Math.random() > .5){
            document.getElementById("coin").src = "assets/images/heads.svg" //place heads coin image path here
            heads ++;
            flips ++;
            ...
            document.getElementById("coin").src ="assets/images/tails.svg" //place tails coin image path here
            tails ++;
            flips ++;
